...
class VG_Relation(Dataset):
    ...
    def __getitem__(self, index):
        ...
        sample_path = test_case["image_path"]
        sample_id = test_case['image_id']+'_'+test_case['relation_info']['name']+test_case['primary_object_name']
        true_caption = test_case["true_caption"]
        false_caption = test_case["false_caption"]
        query = 'Which caption is correct: '+false_caption+' or '+true_caption+'?'
        answer =true_caption
...
class COCO_Order(Dataset):
    ...
    def __getitem__(self, index):  
        ...
        item = edict({"image_options": [image], "caption_options": test_case["caption_options"],"image_path":test_case["image"]})
        return item
