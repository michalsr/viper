...
image = Image.open('/home/michal5/winoground/data/images/ex_62_img_0.png').convert('RGB')
def execute_command(image) -> str:
    ...
    if coerce_to_numeric(left_flag_stars) == 5 and coerce_to_numeric(right_flag_stars) == 50:
        return "yes"
    else:
        return "no"
